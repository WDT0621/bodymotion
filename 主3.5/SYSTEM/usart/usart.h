...
#define BUFF_LEN_MAX1 50		//串口1最大帧长（字节）
#define BUFF_LEN_MAX2 50		//串口2最大帧长（字节）
...
#define COMM_BIND_ADDR     0x68     //设置绑定地址
#define COMM_BT_RESTORE	 	 0x69	 		//蓝牙模块恢复出厂配置
...
#define FACTORY_RESTORE	0x06		//恢复出厂设置
